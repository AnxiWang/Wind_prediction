...
GTS = pd.read_csv('../../data/GTS/GTS_2014_wind.csv', encoding='utf-8')
sta_wrf_pred = pd.read_csv('../../data/output/sta_wrf_pred_2014.csv', encoding='utf-8')
...
res = sta_wrf_pred_from_UV.merge(GTS, left_on=['Station_Id', 'PredTime'], right_on=['stationID', 'Time'])
# res.to_csv('../../data/output/dataset_2014.csv', encoding='utf-8')
...
dataset.to_csv('../../data/output/dataset_2014.csv', encoding='utf-8')
